...
namespace mio
{
    namespace metaprogram
    {
        ...
        template <typename Key, size_t N, class Hash = hash<Key>, class KeyEqual = std::equal_to<Key>>
        class unordered_set
        {
        public:
            class iterator;
        ...
        private:
            ...
            using base_container_t = typename std::array<std::optional<Key>, N>;
        ...
        public:
            ...
            public:
                constexpr iterator(const unordered_set *set, decltype(cur_) cur) : set_(set), cur_(cur){};
            ...
            public:
                constexpr const_iterator(const unordered_set *set, decltype(cur_) cur) : set_(set), cur_(cur){};
            ...
            constexpr unordered_set(const std::initializer_list<key_type> &val_list)
            {
                if (val_list.size() > N)
                {
