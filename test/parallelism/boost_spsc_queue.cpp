...
public:
    ...
    void run_one()
    {
        typedef boost::lockfree::spsc_queue<std::array<char, DATA_SIZE_>, boost::lockfree::capacity<BUF_SIZE>> ring_queue_t;
